...
export const GARBAGE_COLORS: Record<GarbageType, string> = {
  [GarbageType.BURNABLE]: 'bg-rose-50 text-rose-600 border-rose-200',
  [GarbageType.NON_BURNABLE]: 'bg-slate-50 text-slate-600 border-slate-200',
  [GarbageType.PLASTIC]: 'bg-pink-50 text-pink-600 border-pink-200',
  [GarbageType.RECYCLABLE]: 'bg-blue-50 text-blue-600 border-blue-200',
  [GarbageType.PAPER]: 'bg-orange-50 text-orange-600 border-orange-200',
  [GarbageType.BOTTLES_CANS]: 'bg-emerald-50 text-emerald-600 border-emerald-200',
  [GarbageType.LARGE]: 'bg-violet-50 text-violet-600 border-violet-200',
  [GarbageType.OTHER]: 'bg-gray-50 text-gray-600 border-gray-200',
};
